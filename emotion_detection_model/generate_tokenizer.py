...
# Fungsi ini harus sama persis dengan yang Anda gunakan untuk melatih model.
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Sekarang, pindahkan file ini ke dalam folder 'emotion_detection_model' Anda.")
